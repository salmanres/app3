                    ...
                    <div className='col-lg-5 col-md-6 col-sm-7 col-10 mt-4'>
                        <div className="card border-warning mb-3 rounded-0 shadow-sm mt-2">
                            ...
                            <div className="card-body">
                                <input type='text' placeholder='Registration Number' className='form-control p-2 d-input mb-2 input-box2' name='registration' value={carData.registration} onChange={handleChange} />
                                ...
                                <input type='text' placeholder='Driver Name' className='form-control p-2 mb-2 input-box2 d-input' name='drivername' value={carData.drivername} onChange={handleChange} />
                                <input type='text' placeholder='Driver Number' className='form-control p-2 mb-2 input-box2 d-input' name='drivernumber' value={carData.drivernumber} onChange={handleChange} />
                                ...
                                {/* <input type='button' className='btn btn-warning p-2 w-100 button-1 rounded-0' onClick={handleSubmit} value="ADD VEHICLE">
                                </input> */}
                            </div>
                        </div>
                        {/* <form>
